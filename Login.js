    ...
    return (
        <>
            <div className="section1">
                ...
                <div className="shape-img1"><img loading="lazy" src="" alt="s" /></div>
                <div className="shape-img2"><img loading="lazy" src="" alt="s" /></div>
                {/* <div className="shape-img3"><img loading="lazy" src="" alt="s" /></div> */}
                {/* <div className="shape-img4"><img loading="lazy" src="" alt="s" /></div>*/}
                <div className="shape-img5"><img loading="lazy" src="" alt="s" /></div>
                {/* <div className="shape-img6"><img loading="lazy" src="" alt="s" /></div> */}
                <div className="shape-img7"><img loading="lazy" src="" alt="s" /></div>
                <div className="shape-img8"><img loading="lazy" src="" alt="s" /></div>
                <div className="shape-img9"><img loading="lazy" src="" alt="s" /></div>
                {/* <div className="shape-img10"><img loading="lazy" src="" alt="s" /></div> */}
                <div className="shape-img11"><img loading="lazy" src="" alt="s" /></div>
                <div className="shape-img14"><img loading="lazy" src="" alt="s" /></div>
                <div className="shape-img12"><img loading="lazy" src="" alt="s" /></div>
                <div className="shape-img13"><img loading="lazy" src="" alt="s" /></div>
                <div className="right">
